...
st.markdown(
    ...
    *, html, body, p, label, input, button, h1, h2, h3, h4, h5, h6, [data-testid="stMarkdownContainer"] {
    ...
    /* ==========================================
       BLUE GLOW STYLES FOR INNER DASHBOARD BUTTONS
       ========================================== */
    div.stButton > button, div.stDownloadButton > button {
        ...
        box-shadow: 0 0 15px rgba(0, 162, 255, 0.45) !important;
        text-transform: uppercase !important;
        letter-spacing: 1px !important;
        transition: none !important;
    }

    /* Flat Static Hover Behavior Matrix matching Submit logic */
...
if not st.session_state.auth_state:
    ...
    # Context Restored: Original 6-color looping title displays on launch screen
    st.markdown(
        """
