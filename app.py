...
def render_galaxy_component(
    ...
    """
    # Safe multi-line string containing raw code mapping without f-string conflicts
    html_code = """
    <!DOCTYPE html>
    <html>
    <head>
    ...
    """
    # Safe execution injection replacing parameters cleanly
...
if not st.session_state.auth_state:
    # High-fidelity balanced side-by-side splitscreen preventing layout mouse block errors
    ...
    with panel_col1:
        ...
        # Embedded WebGL engine drawing coordinates locally within the panel frame context
        render_galaxy_component(
            height=460,
            density=1.6,
            glow_intensity=0.6,
            saturation=1.0,
            hue_shift=260, # Perfect cosmic pink/purple color match to your typography loop
            star_speed=0.6,
